...
<head>
    ...
    <title>Admin Kodak Printing</title>
                ...
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand">
                        <a href="/admindash" class="logo-link">
                            ...
                            <span>  &nbsp;<a href="/admin-home"><B style="font-size:19px; color:lightgoldenrodyellow;">Admin Kodak Printing <b style="color:lightskyblue;">System</b></B></a></span>
                        </a>
                    ...
                    <div class="nk-sidebar-content">
                        <div class="nk-sidebar-menu" data-simplebar>
                            ...
                            <li class="nk-menu-item">
                                ...
                                <li class="nk-menu-item">
                                    <a href="/feedbacklist" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-chat"></em></span>
                                        <span class="nk-menu-text">Customer Feedback</span>
                                    </a>
                                </li>
                                    </ul>
                                </li>
