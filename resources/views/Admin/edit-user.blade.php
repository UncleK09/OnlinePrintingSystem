...
<h2 class="nk-block-title">Update User</h1>
<nav>
...
<div class="card-body">
<div class="bio-block">
<h4 class="bio-block-title mb-4">Edit Details</h4>
    ...
    <div class="row g-3">
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <input type="number" class="form-control" id="phone" name="phone" value="{{ $user->phone }}" placeholder="Phone" required>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="form-group">
                <label for="password" class="form-label">Change Password <sup>[Optional]</sup></label>
                <div class="form-control-wrap">
        ...
        <div class="col-lg-12">
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <textarea  class="form-control" id="address" name="address" maxlength="500" required>{{ $user->address }}</textarea>
                </div>
            </div>
        </div>
